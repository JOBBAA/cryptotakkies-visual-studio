...
TYPOGRAPHY — CRITICAL:
The brand uses "ABC Favorit Condensed Black" (also known as "Favorit Ultra") as its main display font.
- This is an EXTREMELY HEAVY, COMPRESSED, GEOMETRIC sans-serif typeface
- Characteristics: very condensed/narrow letter width, ultra-black weight, sharp geometric letterforms, tight letter spacing
- Similar to: Impact, Oswald Ultra Bold, or Tungsten Black — but more geometric and modern
- Use ALL LOWERCASE for display text — this is a key brand signature
- Body text uses a clean, modern sans-serif (similar to Favorit Regular — clean, geometric, well-spaced)
- NEVER use serif fonts, script fonts, or decorative fonts

VECTOR CHARACTER STYLE (when including people):
The brand uses flat, minimal vector illustrations of diverse young professionals. EXACT style:
- FULLY FLAT design: absolutely NO outlines, NO borders, NO gradients — only solid color shape fills
- Color palette for clothing: mint green (#2ECC71), dark green (#1B5E3B), light mint (#A8E6CF), white, black
- Skin tones: diverse, warm — ranging from light peach to dark brown
- Hair: solid black, simple shapes — no detailed strands
- Faces: extremely minimal — just a simple curved smile line, NO detailed eyes/nose (some have simple dot eyes)
- Proportions: realistic adult proportions, slightly elongated/stylized legs
- Clothing style: casual professional — t-shirts, sweaters, jackets, backpacks, headphones
- Activities: reading books, holding tablets/laptops, writing in notebooks, looking at phones, walking with bags
- NO hand-drawn/sketch style, NO cartoon proportions, NO chibi style — this is modern corporate flat illustration
- Similar to: Notion illustrations, Telegram stickers, or humaaans.com style
`;
